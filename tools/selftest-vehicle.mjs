...
console.log("Цели в карточке урона — документы, а не идентификаторы");
{
  ...
  for (const name of ["vehicle-sheet", "area-attacks"]) {
...
// Проверки зоны поражения переехали в tools/selftest-area.mjs вместе с самой
// механикой: она больше не принадлежит листу транспорта и работает при
// выстреле с любого листа.
